...
const PROJECTS = [
  ...
  },
  {
    ...
    solution: 'Led a 4-member team to build custom Odoo ERP modules in Python — automating event scheduling, membership payments, and notifications. Added REST + Webhook endpoints for real-time sync.',
    outcome: 'Analytics dashboards surfaced budget, participation trends & ROI for club admins. Strong team project shipped under competition conditions.',
